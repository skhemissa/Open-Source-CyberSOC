...
Otherwise:
2. Get in IPAM (e.g. “Ecosystem” section) the security officers assigned to subnet associated to internal IPs or the location concerned by the alert;
...
> This automation solution supports OpenAPI that accelerates the implementation of  playbooks.
...
> Open source database: [Postgresql](https://www.postgresql.org/), [MariaDB](https://mariadb.com/kb/en/documentation/), etc.
...
>  Open source RESTful API: [PostgREST](http://postgrest.org) for Postgresql et [MaxScale for MariaDB](https://mariadb.com/kb/en/maxscale/).
...
> Open source solution: [OpenVPN](https://openvpn.net/).

> Open source solution: MFA > **TODO**.
